...
function minJumps(input: number[]): number {
    const util = new Util(input);
    return findMinJumpsFromStartToGoal(input, util);
};

function findMinJumpsFromStartToGoal(input: number[], util: Util): number {
...
function handleJumpToAdjacentIndexes(index: number, queue: Queue<number>, visited: boolean[], util: Util): void {
...
function handlePrimeTeleportation(index: number, input: number[], queue: Queue<number>, visited: boolean[], util: Util): void {
...
class Util {
    ...
    primes: boolean[];
    valueToIndexes: Map<number, Array<number>>;
    ...
    createSieveOfEratosthenes(): boolean[] {
    ...
    createMapValueToIndexes(input: number[]): Map<number, Array<number>> {
